...
// I2C "Hardened IP" block from Lattice
namespace Antmicro.Renode.Peripherals.I2C
{
    public class LatticeHIP : SimpleContainer<II2CPeripheral>, IDoubleWordPeripheral
    {

        public LatticeHIP(Machine machine) : base(machine)
        {
            IRQ = new GPIO();
        }
